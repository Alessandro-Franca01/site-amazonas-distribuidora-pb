...
<body>
        ...
        <section class="py-16 bg-gray-100" id="promocao">
            <div class="container mx-auto px-6 promo-section md:flex md:justify-around">
                ...
                <div class="promo-item text-center md:w-1/2 px-4">
                    <a href="https://api.whatsapp.com/send?phone=5583993615903" target="_blank" class="block">
    ...
    <!-- Botão do whatssap -->
    <a href="https://api.whatsapp.com/send?phone=5583993615903"
        target="_blank"
            ...
            <div class="grid md:grid-cols-4 gap-8 mb-8"> <!-- Mudei para 4 colunas -->
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="social-icon">
                            <a class="text-gray-300 hover:text-yellow-400 transition duration-300" href="https://api.whatsapp.com/send?phone=555583993615903">
