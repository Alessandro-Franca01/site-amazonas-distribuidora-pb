...
<body class="bg-gray-50 font-poppins text-gray-800 min-h-screen flex items-center justify-center p-5 relative overflow-x-hidden">
    ...
    <main class="w-full flex items-center justify-center">
        <div class="max-w-xl w-full p-8 md:p-10 bg-white rounded-3xl shadow-2xl text-center relative animate-fade-in">
            <div class="text-amber-500 mb-5 text-8xl animate-pulse">
                <i class="fas fa-clock"></i>
            </div>
            
            <div class="text-amber-500 font-extrabold text-[120px] md:text-[140px] leading-none mb-2 opacity-80" style="text-shadow: 3px 3px 0 rgba(0, 0, 0, 0.05);">419</div>
            ...
            <p class="text-lg text-gray-600 leading-relaxed mb-8">
                Sua sessão expirou por inatividade ou o token CSRF está inválido. Por favor, atualize a página e tente novamente.
            </p>
            ...
            <div class="flex flex-col md:flex-row gap-4 justify-center mt-6">
                ...
                <a href="javascript:location.reload()" class="inline-flex items-center px-6 py-3 bg-amber-500 text-white rounded-full font-semibold transition-all duration-300 ease-in-out hover:bg-amber-600 transform hover:-translate-y-1 shadow-md hover:shadow-lg">
                    <i class="fas fa-sync-alt mr-3"></i> Atualizar página
                </a>
            </div>
