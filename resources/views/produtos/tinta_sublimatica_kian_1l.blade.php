...
<head>
    ...
    <title>Tinta Sublimática Kian 1L - Amazonas Distribuidora PB</title>
    ...
    <div class="bg-gray-200 py-2">
        <div class="container mx-auto px-6">
            <div class="flex items-center text-sm">
                ...
                <span class="breadcrumb-item text-gray-600">Tinta Sublimática Kian 1L</span>
            </div>
        </div>
    </div>
                ...
                <div class="flex flex-col lg:flex-row gap-6 md:gap-12">
                    ...
                    <div class="w-full lg:w-1/2">
                        <div class="bg-white p-2 md:p-4 rounded-lg shadow-lg">
                            <img src="{{ asset('images/produtos/tinta_sublimatica_kian_1l.jpeg') }}" 
                    ...
                    <div class="w-full lg:w-1/2 mt-6 lg:mt-0">
                        <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-700 mb-3 md:mb-4">Tinta Sublimática Kian 1L</h1>
                        
                        <div class="bg-gray-100 p-4 md:p-6 rounded-lg mb-4 md:mb-6">
                            <p class="text-base md:text-lg text-gray-700 mb-3 md:mb-4">
                                A tinta mais conhecida pela sua confiabilidade absoluta. Indicada para uma produção industrial, pela possibilidade de impressão em papéis leves ou não tratados.
                                Ideal para produção de moda, decoração interior, vestuário esportivo, uniformes e acessórios de esporte ou esporte ou para Transferência em substratos rígidos pré tratados.
                                Compatível com cabeças de impressão cabeça Epson.
                            </p>
                        </div>
                        
                        <div class="flex flex-col sm:flex-row items-center gap-3">
                            <a href="https://api.whatsapp.com/send?phone=5583993615903&text=Olá! Gostaria de informações sobre a Tinta Sublimática Kian 1L" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <table class="w-full">
                                <tbody>
                                    <tr class="border-b border-gray-100">
                                        ...
                                        <td class="py-3 text-gray-800">Tinta Sublimática Kian 1L</td>
                                    </tr>
                                    <tr class="border-b border-gray-100">
                                        <td class="py-3 text-gray-600 font-medium">Marca</td>
                                        <td class="py-3 text-gray-800">Kian</td>
                                    </tr>
                                    <tr class="border-b border-gray-100">
                                        <td class="py-3 text-gray-600 font-medium">Modelo</td>
                                        <td class="py-3 text-gray-800">Hi pró</td>
                                    </tr>
                                    <tr class="border-b border-gray-100">
                        ...
                        <div class="p-6">
                            ...
                            <table class="w-full">
                                <tbody>
                                    <tr class="border-b border-gray-100">
                                        <td class="py-3 text-gray-600 font-medium">Forma de Venda</td>
                                        <td class="py-3 text-gray-800">Unidade</td>
                                    </tr>
                                    <tr class="border-b border-gray-100">
                                        <td class="py-3 text-gray-600 font-medium">É apto para sublimação</td>
                                        <td class="py-3 text-gray-800">Sim</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
