...
<head>
    ...
    <title>Primer PA02 940ml - Amazonas Distribuidora PB</title>
                ...
                <div class="flex flex-col lg:flex-row gap-6 md:gap-12">
                    ...
                    <div class="w-full lg:w-1/2 mt-6 lg:mt-0">
                        ...
                        <div class="flex flex-col sm:flex-row items-center gap-3">
                            <a href="https://api.whatsapp.com/send?phone=83998530445&text=Olá! Gostaria de informações sobre o Primer PA02 940ml" 
